monNSRothC 2.0 – monthly NonStandard RothC model in Matlab
...
monNSRothC is a MATLAB routine (version R2017b) for implementig the nonstandard version of the RothC model for simaluting the dynamics of soil organic carbon (SOC) contained in the organic matter. 
